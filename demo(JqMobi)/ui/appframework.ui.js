...
(function($) {
    ...
    var touchLayer = function(el) {
        ...
        this.launchFixUI(5); //try a lot to set 分页 into place
    };
        ...
        onScroll: function(e) {
            ...
            if (!this.allowDocumentScroll_ && !this.isPanning_ && e.target == (document)) {
                ...
                if (this.wasPanning_) {
                    ...
                    //this.log("scroll forced 分页 into place");
                    this.launchFixUI();
                }
            }
        },
        ...
        onTouchStart: function(e) {
            ...
            if (!this.isPanning_ && !this.requiresNativeTap) {
                if ((this.isScrolling && !$.feat.nativeTouchScroll) || (!this.isScrolling))
                    e.preventDefault();
                //demand vertical scroll (don't let it pan the 分页)
 ...
 */ (function($) {
    ...
    ui.prototype = {
         ...
         * This is a boolean property.  When set to true (default) it will load that panel when the app is started
           ```
           $.ui.loadDefaultHash=false; //Never load the 分页 from the hash when the app is started
        ...
        */
         ...
         * This is called internally by loadContent.  Here we are using Ajax to fetch the data
           ```
           $.ui.loadDiv("分页.html",false,false,"up");
           ```
         * @param {String} target
         * @param {Boolean} newtab (resets history)
         * @param {Boolean} go back (initiate the back click)
        ...
        launch: function() {
            ...
            //分页 title (should optionally be left to developer..)
            ...
            if (this.firstDiv) {
                ...
                var loadFirstDiv = function() {
                    ...
                    if (firstPanelId.length > 0 && that.loadDefaultHash && !isFirstPanel) {
                        that.loadContent(defaultHash, true, false, 'none'); //load the active 分页 as a newTab with no transition
                    }
        ...
        /**
         * This blocks the 分页 from scrolling/panning.  Usefull for native apps
         */
